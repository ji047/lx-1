<template>
    <div>
        ...
        <div class="pad20">
            ...
            <div class="iread" v-if="showBack">
                <van-checkbox v-model="T" disabled>我已阅读此离校须知会按要求完成离校手续办理</van-checkbox>
            </div>
        ...
        methods: {
            ...
            read() {
                ...
                if (this.checked === true && this.$store.getters.myInfo.readflag == '0') {
                    this.$ajax.post('/student/save', {readflag: "1", studentid: this.$store.getters.myInfo.studentid})
                        .then(res => {
                            console.log(res)
